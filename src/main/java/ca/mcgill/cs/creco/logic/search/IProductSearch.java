...
public interface IProductSearch {
	 ...
	 * @param queryString The string to match against product names and other fields.
	 * @param eqClassID The ID of the equivalence class within which the search will focus.
	 ...
	 */
	List<ScoredProduct> queryProductsReturnAll(String queryString, String eqClassID);
}
