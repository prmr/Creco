 ...
 */
@Component
public final class CRData2 implements IDataCollector, IDataStore
{
	...
	private CRData2() throws IOException
	{
		this(DEFAULT_PRODUCT_FILENAMES, DEFAULT_CATEGORY_FILENAME);
	}
	
	private CRData2(String[] pProductFileNames, String pCategoryFileName) throws IOException
	{
